...
## How the Selector System Works (v1.5.1)

As of v1.5.1, **input box selectors** use a multi-strategy resolver defined centrally in `extension/src/platform/resolver.ts`.
